...
def main():
    tests = [
        ...
        ('apps/cse40/expected_images/resized_image.png', 'apps/basic-processing/output_images/resized_image.png', 'Resized Image'),
        ('apps/cse40/expected_images/rotated_90_image.png', 'apps/basic-processing/output_images/rotated_90_image.png', 'Rotated Image'),
        ('apps/cse40/expected_images/sharpened_image.png', 'apps/basic-processing/output_images/sharpened_image.png', 'Sharpened Image'),
